...
class Reqres_api():
    ...
    @staticmethod
    def get_of_users():
        get_resource = "users?=2"  # Ресурс метода GET список пользователей  (Изменен ресурс => users?page=2)
    ...
    @staticmethod
    def get_single_user():
        get_resource = "users"      # Ресурс метода GET один пользователь  (Изменен ресурс => users/2)
        get_url = base_url + get_resource
        print(get_url)
        result_get = Http_methods.get(get_url)
        print(result_get.text)
    ...
    def get_user_not_found():
        get_resource = "us"  # Ресурс метода GET пользователь не найден (Изменен ресурс => users/23 )
        get_url = base_url + get_resource
        print(get_url)
        result_get = Http_methods.get(get_url)
        print(result_get.text)
    ...
    def get_list_resource():
        get_resource = "own"  # Ресурс метода GET список ресурсов  (Изменен ресурс => unknown)
        get_url = base_url + get_resource
        print(get_url)
        result_get = Http_methods.get(get_url)
        print(result_get.text)
    ...
    def get_single_resource():
        get_resource = "unknown"  # Ресурс метода GET один ресурс  (Изменен ресурс => unknown/2)
        get_url = base_url + get_resource
        print(get_url)
        result_get = Http_methods.get(get_url)
        print(result_get.text)
    ...
    def get_resource_not_found():
        get_resource = "unknown"  # Ресурс метода GET ресурс не найден  (Изменен ресурс => unknown/23 )
        get_url = base_url + get_resource
        print(get_url)
        result_get = Http_methods.get(get_url)
        print(result_get.text)
    ...
    def create_new_place():
        ...
        post_resource = "user"  # Ресурс метода Post   (Изменено тело запроса =>"name": "morpheus", "job": "leader")
    ...
    def put_update():
        ...
        put_resource = "users/2"  # Ресурс метода PUT обновить (Изменено тело запроса =>"name": "morpheus", "job": "leader")
    ...
    def patch_update():
        ...
        patch_resource = ""         # Ресурс метода PATCH обновить (Изменен ресурс => users/1)
    ...
    @staticmethod
    def delete():
        delete_resource = ""  # Ресурс метода DELETE (Изменен ресурс => users/10)
    ...
    def register_successful():
        ...
        post_resource = ""  # Ресурс метода Post  успешная регистрация    (Изменен ресурс => register)
        post_url = base_url + post_resource
        print(post_url)
    ...
    def register_unsuccessful():
        ...
        post_resource = "regi"  # Ресурс метода Post  неудачная регистрация  (Изменен ресурс => register)
        post_url = base_url + post_resource
        print(post_url)
    ...
    def login_successful():
        ...
        post_resource = ""  # Ресурс метода Post успешный вход в систему (Изменен ресурс => login)
        post_url = base_url + post_resource
        print(post_url)
    ...
    def login_unsuccessful():
        ...
        post_resource = "lo"  # Ресурс метода Post неудачный вход в систему (Изменен ресурс => login)
        post_url = base_url + post_resource
        print(post_url)
    ...
    def get_delayed_response():
        get_resource = "?delay=3"  # Ресурс метода GET запоздалый ответ (Изменен ресурс => users?delay=3)
        get_url = base_url + get_resource
        print(get_url)
        result_get = Http_methods.get(get_url)
        print(result_get.text)
