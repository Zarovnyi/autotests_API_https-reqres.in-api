...
class Logger():
    file_name = f"D:\\Python\\control_work_API_UI\\logs_api\\log_" + str(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")) + ".log"
    ...
    def add_request(cls, url: str, method: str):
        ...
        data_to_add += f"Request methodd: {method}\n"
        data_to_add += f"Request URL: \n"
        data_to_add += "\n"
